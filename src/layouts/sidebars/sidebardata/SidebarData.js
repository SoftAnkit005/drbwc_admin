...
const SidebarData = [
  ...
  { title: 'Add Coupons', href: '/add-coupon', icon: <MdAddLink className='fs-3'/>, id: 1.3, collapisble: false, },

  { caption: 'Catalog' },
  { title: 'Products', href: '/products', icon: <HiOutlineInboxStack className='fs-3'/>, id: 2.1, collapisble: false, },
  { title: 'Categories', href: '/categories', icon: <MdOutlineCategory className='fs-3'/>, id: 2.2, collapisble: false, },
  { title: 'Attributes', href: '/attributes', icon: <MdSettingsInputComponent className='fs-3'/>, id: 2.3, collapisble: false, },
  { title: 'Tags', href: '/tags', icon: <LuTags className='fs-3'/>, id: 2.4, collapisble: false, },
  { title: 'Reviews', href: '/reviews', icon: <MdOutlineReviews className='fs-3'/>, id: 2.5, collapisble: false, },
