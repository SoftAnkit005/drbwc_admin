...
import { Card, CardBody, CardTitle, Row, Col, Form, FormGroup, Label, Input, FormText, Button, InputGroup, InputGroupText, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem, FormFeedback, } from 'reactstrap';
              ...
              <Row>
                ...
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    ...
                    <Input type="text" id="" placeholder="SKU" />
                  </FormGroup>
                </Col>
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    <Label htmlFor="">Price</Label>
                    <Input type="text" id="" placeholder="Price" />
                  </FormGroup>
                </Col>
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    <Label htmlFor="">Use For</Label>
                    <Input type="text" id="" placeholder="Use For" />
                  </FormGroup>
                </Col>
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    <Label htmlFor="">Power Source</Label>
                    <Input type="text" id="" placeholder="Power Source" />
                  </FormGroup>
                </Col>
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    <Label htmlFor="">Material</Label>
                    <Input type="text" id="" placeholder="Material" />
                  </FormGroup>
                </Col>
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                ...
                <Col className="py-1" md="6" lg="4" xl="3">
                  <FormGroup>
                    ...
                    <Input type="text" id="" placeholder="Color" />
                  </FormGroup>
                </Col>
                <Col className="py-1" lg="9">
                  <FormGroup>
                    <Label htmlFor="">Company Details</Label>
                    <Input type="textarea" placeholder="Company Details" />
                  </FormGroup>
                </Col>
                <Col className="py-1" xs="12">
                  <FormGroup>
                    <Label htmlFor="">Video Link</Label>
                    <Input type="text" id="" placeholder="Video Link" />
                  </FormGroup>
                </Col>
                <Col className="py-1" xs="12">
                  <FormGroup>
                    <Label htmlFor="">Amazon Link</Label>
                    <Input type="text" id="" placeholder="Amazon Link" />
                  </FormGroup>
                </Col>
                <Col className="py-1" xs="12">
                  <FormGroup>
                    <Label htmlFor="">Flipkart Link</Label>
                    <Input type="text" id="" placeholder="Flipkart Link" />
                  </FormGroup>
                </Col>
                <Col className="py-1" xs="12">
                  <FormGroup>
                ...
                <Col className="py-1" xs="12">
                  <FormGroup>
                    <Label htmlFor="examplePassword2">Tax Class</Label>
                    <Input type="select" id="">
                      <option>Select...</option>
                      <option>One</option>
                      <option>Two</option>
                ...
                <Col className="py-1" xs="12">
                  <FormGroup>
                    <Label htmlFor="examplePassword2">Description</Label>
